...
describe("sanitizeString data URIs", () => {
  it("blocks dangerous data URIs", () => {
    ...
    expect(sanitizeString("data:application/xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjxzY3JpcHQ+YWxlcnQoMSk8L3NjcmlwdD48L3N2Zz4=")).toBe("#blocked-uri");
  });

  it("blocks dangerous data URIs obfuscated with &comma; and &semi;", () => {
    expect(sanitizeString("data:text/html&semi;base64&comma;PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg==")).toBe("#blocked-uri");
  });
});
