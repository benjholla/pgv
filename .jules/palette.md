...
## 2026-08-20 - [Add role="group" and aria-label to control groups]
...
**Action:** When grouping related interactive elements, ensure the container has `role="group"` and a descriptive `aria-label` to improve accessibility and navigation for screen reader users.
