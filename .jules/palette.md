...
## 2026-09-06 - [Added role="group" to structural DOM button groups]
...
**Action:** Always add `role="group"` and an `aria-label` to dynamically created DOM container elements that group related action buttons.
