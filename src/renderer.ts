...
export class GraphView {
  ...
  #renderSmartViewControls(): HTMLElement {
    ...
    if (!this.#smartControlsExpanded) {
      ...
      expandBtnGroup.setAttribute("aria-label", "Smart view controls");
    ...
    originBtnGroup.setAttribute("aria-label", "Traversal origin controls");
    ...
    const createStepControl = (type: "Reverse" | "Forward", currentVal: number | undefined, prevVal: number) => {
      ...
      if (type === "Reverse") {
        ...
        shiftUpBtnGroup.setAttribute("aria-label", "Shift steps up");
        ...
        shiftDownBtnGroup.setAttribute("aria-label", "Shift steps down");
