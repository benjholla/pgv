...
export class GraphView {
  ...
  #drawMinimap(canvas: HTMLCanvasElement): void {
    ...
    const getOffsets = (edgeId: string, sourceId: string, targetId: string) => {
      ...
      return { sourceOffsetPx: sOffset, targetOffsetPx: tOffset, outIndex, inIndex };
    };
    ...
    for (const edge of this.#graph.edges.values()) {
      ...
      const endpoints = edgeEndpoints(edge, layout, offsets.sourceOffsetPx, offsets.targetOffsetPx, offsets.outIndex, offsets.inIndex);
