...
export function sanitizeString(value: string): string {
  ...
  // We match `=`, `&equals;`, and numerical entities for `=` to prevent obfuscated payloads.
  sanitized = sanitized.replace(/(^|[^a-z0-9])o[\s\x00-\x1F\x7F]*n(?:[\s\x00-\x1F\x7F]*[a-z])+[\s\x00-\x1F\x7F]*(?:=|&equals;?|&#x3d;?|&#61;?)/gi, "$1data-blocked=");
