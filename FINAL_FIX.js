...
const sigOld = 'export function verticalLayout(\n  graph: GraphSnapshot,\n  options: VerticalLayoutOptions = {},\n  previousLayout?: LayoutSnapshot,\n): LayoutSnapshot {';
const sigNew = 'export function verticalLayout(\n  graph: GraphSnapshot,\n  options: VerticalLayoutOptions = {},\n  previousLayout?: LayoutSnapshot,\n  schema?: GraphSchema\n): LayoutSnapshot {';
if (code.includes(sigOld)) {
...
if (codeRenderer.includes('// Temporary change: Calculate nodes that act as parents in containment relationships')) {
